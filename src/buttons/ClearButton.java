 ...
 */
public final class ClearButton extends RectangularButton {
    ...
    static {
        DEFAULT_HALF_SIZE = new Vector2D(60, 20);
        HOVERED_OVER_HALF_SIZE = new Vector2D(60, 25);
        PRESSED_HALF_SIZE = new Vector2D(70, 25);
        
        DEFAULT_COLOR = Color.RED;
        HOVERED_OVER_COLOR = DEFAULT_COLOR.darker();
        PRESSED_COLOR = HOVERED_OVER_COLOR.darker();
        
        IMAGE = Convenience.imageFromPathName("images/clear.PNG");
    }
    
    public ClearButton(Vector2D position, Scene usedScene) {
